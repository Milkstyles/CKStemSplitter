...
1. Builds the JUCE VST3 and native Audition clipboard bridge with Visual Studio.
...
6. Packages the Audition panel, bridge, VST3, frozen engine, ONNX Runtime dependencies, and model cache with Inno Setup.
