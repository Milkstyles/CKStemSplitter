...
- v1.0.8 removes the generic repeat-effect shortcut and reopens CK Stem Splitter by its exact accessible Effects-menu entry, so unrelated effects such as Reverb cannot appear.
